...
# BASE_DIR = /app/urlshortener/ (outer directory with static/, templates/)
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-!fr4f-bhr4lit=$9q_r#vy)%of=z2qhw16%s_e7=4w(0u%zag%')
